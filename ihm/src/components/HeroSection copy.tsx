...
const HeroSection = () => (
  ...
  <section className="relative bg-hero overflow-hidden flex items-center mt-20">
    ...
    <div className="absolute inset-0 hidden md:block pt-2 ">
      <img src="./hero/1.png" alt="Lexicon MILE Campus" className="w-full h-auto object-cover object-top" />
    ...
    <div className="relative z-10 max-w-8xl mx-auto px-4 sm:px-6 py-0 sm:py-12  grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center w-full">
      {/* <motion.div
