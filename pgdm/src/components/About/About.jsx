        ...
        <div className="flex flex-wrap-reverse items-center ">
          <div className="w-full lg:w-1/2 lg:pe-12">
            ...
            <p className="text-justify">
              ...
              specialized training academies, the Lexicon ecosystem is a
              holistic platform for talent development.
            </p>
            <br />
            <p className="text-justify">
              At Lexicon MILE, our philosophy-One Student at a Time-has evolved
              into the global positioning of, "A Mentor Every MILE." We invest
              deeply in the personal journey of each learner, combining academic
              rigor, mentorship from industry leaders, and global exposure to
          ...
          <div className="w-full lg:w-1/2 mb-4 lg:mb-0">
            ...
            <img
              src="./about/1.jpg"
              className="w-full object-cover h-full rounded-lg border "
              alt=""
            />
          </div>
        </div>
