    ...
    <div className="px-4 lg:px-20 pt-12 pb-6" id="placements">
        <div className="flex flex-wrap">
            <div className="w-full lg:w-6/12 flex flex-col items-start mb-8 lg:mb-0">
                ...
                <h2 className="text-4xl lg:text-5xl font-bold mb-4 text-blue-950">The Lexicon Edge: MBA Global</h2>
                <div className="flex flex-wrap">
                    ...
                    <ul className="list-disc ps-6 lg:py-2">
                        <li className="text-md  mb-1">The program fee covers one-way travel from India to the UK along with the Student Tier 4 visa.</li>
                    ...
                    <ul className="list-disc ps-6 lg:py-2">
                        ...
                        <li className="text-md  mb-1">Zero Visa Rejections (Last 7 Years)</li>
