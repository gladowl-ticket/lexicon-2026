...
<section>
    <div className=" pb-12 max-w-8xl px-4 lg:px-20 " id="about">
        <div className="flex flex-wrap-reverse items-center ">
            <div className="w-full lg:w-1/2 lg:pe-12">
                ...
                <p className="text-justify">Founded in 2009 as part of the Lexicon Group of Institutes (est. 2006),
                    ...
                    training academies, the Lexicon ecosystem provides a holistic platform for talent development.
                </p>
                <br />
                <p className="text-justify">At Lexicon MILE, our philosophy — One Student at a Time — has evolved into
                    our global positioning of <span className="font-bold">“A Mentor Every MILE.”</span> We invest deeply in each learner’s personal
                    journey, combining academic rigor, mentorship from industry leaders, and global exposure to shape {" "}
                    <span className="font-bold">Day Zero Professionals,</span> ready to step into the workforce and lead from day one.
                </p>
            </div>
        ...
        <div className="flex flex-wrap items-center pt-8 lg:pt-12">
            <div className="w-full lg:w-1/2 mb-4 lg:mb-0">
                <h2 className="text-4xl lg:text-5xl font-bold mb-6 text-blue-950 lg:hidden">About the University of
                    South Wales,
                    UK</h2>
                <img src="./about/2.jpg" className="w-full object-cover h-full rounded-lg border " alt="" />
            </div>
            <div className="w-full lg:w-1/2 lg:ps-12">
                <h2 className="text-4xl lg:text-5xl font-bold mb-6 text-blue-950 lg:block hidden">About the University
                    of South Wales,
                    UK</h2>
                ...
                <p className="text-justify">It's global alumni community spans more than 120 countries, and its
                    ...
                    for Lexicon MILE. Together, we deliver a MBA Global that combines Indian dynamism with UK academic
                    heritage.</p>
            </div>
